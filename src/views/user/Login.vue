    ...
    <div class="login-left">
      <div class="brand-section">
        <!-- <div class="brand-logo">
          <span class="brand-text">KODO</span>
  ...
  methods: {
    ...
    loginSuccess (res) {
      ...
      if (res.data) {
        ...
        // 保存当前商户信息
        if (res.data.current_merchant) {
          localStorage.setItem('currentMerchant', JSON.stringify(res.data.current_merchant))
          localStorage.setItem('currentMerchantId', res.data.current_merchant.id)
        }

        // 保存商户列表
        if (res.data.merchants) {
          localStorage.setItem('merchants', JSON.stringify(res.data.merchants))
        }
      }
